...
{
    public partial class frmPembelianBrowse : ISA.Controls.BaseForm
    {
        DateTime _fromDate, _toDate;
        int _nprint;

        public frmPembelianBrowse()
        {
            InitializeComponent();
        }
        ...
        private void frmPembelianBrowse_Load(object sender, EventArgs e)
        {
        ...
        {
            Pembelian.frmPembelianUpdate ifrmChild = new Pembelian.frmPembelianUpdate(this);
        ...
        private void cmdEDIT_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedCells.Count > 0)
            {
                ...
                {
                    Pembelian.frmPembelianUpdate ifrmChild = new Pembelian.frmPembelianUpdate(this, rowID);
                    Program.MainForm.CheckMdiChildren(ifrmChild);
                }
            }
            else
        ...
        private void cmdCekList_Click(object sender, EventArgs e)
        {
            ...
            {
                Guid rowID = (Guid)dataGridView1.SelectedCells[0].OwningRow.Cells["RowID"].Value;
                Pembelian.frmCekListUpdate ifrmChild = new Pembelian.frmCekListUpdate(this, rowID);
