...
{
    public partial class frmLookUpSurveyor : ISA.Controls.BaseForm
    {
        DataTable _dtCari = new DataTable();
        public Class.clsSurveyor Surveyor { get; set; }

        #region Konstruktor
        public frmLookUpSurveyor()
        {
            InitializeComponent();
        }

        public frmLookUpSurveyor(DataTable dt)
        {
        ...
        private void frmLookUpSurveyor_Load(object sender, EventArgs e)
        {
            Surveyor = new Class.clsSurveyor();
            RefreshGrid();
        }
        ...
        void DBGetList()
        {
            try
            {
                _dtCari = Class.clsSurveyor.DBSearch(txtSearch.Text.Trim());
                RefreshGrid();
            }
            catch (Exception ex)
            {
