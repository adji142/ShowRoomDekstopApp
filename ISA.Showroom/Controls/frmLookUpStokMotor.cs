...
{
    public partial class frmLookUpStokMotor : ISA.Controls.BaseForm
    {
        ...
        #region Konstruktor
        public frmLookUpStokMotor()
        {
            InitializeComponent();
        }

        public frmLookUpStokMotor(DataTable dt)
        {
        ...
        void DBGetList()
        {
            try
            {
                _dtCari = Class.clsStokMotor.DBSearch(txtSearch.Text.Trim());
                RefreshGrid();
            }
            catch (Exception ex)
            {
