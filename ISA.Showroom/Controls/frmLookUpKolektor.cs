...
{
    public partial class frmLookUpKolektor : ISA.Controls.BaseForm
    {
        DataTable _dtCari = new DataTable();
        public Class.clsKolektor Kolektor { get; set; }

        #region Konstruktor
        public frmLookUpKolektor()
        {
            InitializeComponent();
        }

        public frmLookUpKolektor(DataTable dt)
        {
        ...
        private void frmLookUpKolektor_Load(object sender, EventArgs e)
        {
            Kolektor = new Class.clsKolektor();
            RefreshGrid();
        }
        ...
        void DBGetList()
        {
            try
            {
                _dtCari = Class.clsKolektor.DBSearch(txtSearch.Text.Trim());                
                RefreshGrid();
            }
            catch (Exception ex)
            {
