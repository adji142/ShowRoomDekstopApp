...
{
    public class clsKolektor:clsBase
    {
        #region FIELDS
		string _namaKolektor;
		DateTime? _tglMasuk;
		DateTime? _tglKeluar;
        #endregion

        #region PROPERTIES
        public string NamaKolektor { get { return _namaKolektor; } set { _namaKolektor = value; } }
        ...
        public clsKolektor(Guid t_rowID)
        {
            try
            {
        ...
        public void SetFromDataRow(DataRow dr)
        {
            ...
            {
                RowID = (Guid)dr["RowID"];
                _namaKolektor = dr["Nama"].ToString();
            }
            catch (Exception ex)
            {
                throw ex;
            ...
            DataTable dt = new DataTable();
                try
                {
                    using (Database db = new Database())
                    {
                        ...
                        Command cmd = db.CreateCommand("usp_Kolektor_LIST");
                        cmd.Parameters = prm;
        ...
        public static bool DBFind(Guid t_rowID)
        {
            ...
            try
            {
                DataTable dt = DBTools.DBGetDataTableByRowID("usp_Kolektor_LIST", t_rowID);
        ...
        {
            return DBTools.DBGetDataTableByRowID("usp_Kolektor_LIST",t_rowID);
        }
        #endregion
    }
}
