...
{
    public partial class frmCF_LapRencRealPembayaranLuarNegeri : ISA.Controls.BaseForm
    {
        public frmCF_LapRencRealPembayaranLuarNegeri()
        {
            InitializeComponent();
        ...
        private void cmdPRINT_Click(object sender, EventArgs e)
        {
            ...
            {
                db.Commands.Add(db.CreateCommand("rsp_CF_RencRealPembayaranLuarNegeri"));
            ...
            frmReportViewer ifrmReport = new frmReportViewer("CashFlow.rptCF_RencRealPembayaranLuarNegeri.rdlc", Params, dt, "dsCashFlow_LapPembayaran");
            ifrmReport.Show();
        }
    }
}
