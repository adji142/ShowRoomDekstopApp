...
{
    public class clsSurveyor : clsBase
    {
        #region FIELDS
        string _namaSurveyor;
        DateTime? _tglMasuk;
        DateTime? _tglKeluar;
        #endregion

        #region PROPERTIES
        public string NamaSurveyor { get { return _namaSurveyor; } set { _namaSurveyor = value; } }
        ...
        public clsSurveyor(Guid t_rowID)
        {
            try
            {
        ...
        public void SetFromDataRow(DataRow dr)
        {
            ...
            {
                RowID = (Guid)dr["RowID"];
                _namaSurveyor = dr["Nama"].ToString();
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static DataTable DBSearch(string _searchArg)
        {
            ...
            try
            {
                using (Database db = new Database())
                {
                    ...
                    Command cmd = db.CreateCommand("usp_Surveyor_LIST");
                    cmd.Parameters = prm;
        ...
        public static bool DBFind(Guid t_rowID)
        {
            ...
            try
            {
                DataTable dt = DBTools.DBGetDataTableByRowID("usp_Surveyor_LIST", t_rowID);
        ...
        {
            return DBTools.DBGetDataTableByRowID("usp_Surveyor_LIST", t_rowID);
        }
        #endregion
    }
}
