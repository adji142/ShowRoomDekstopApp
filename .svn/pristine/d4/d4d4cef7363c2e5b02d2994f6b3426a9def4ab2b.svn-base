...
{
    public partial class frmCF_RencanaSetoran : ISA.Controls.BaseForm
    {
        List<TextBox> _lTxtJumlah = new List<TextBox>();
        Guid _RowID;

        public frmCF_RencanaSetoran()
        {
            InitializeComponent();
        ...
        private void RefreshData()
        {
            ...
            using (Database db = new Database(GlobalVar.DBName))
            {
                db.Commands.Add(db.CreateCommand("usp_CF_RencanaSetoran_LIST"));
        ...
        private void frmCF_RencanaSetoran_Load(object sender, EventArgs e)
        {
            InitControl();
            SetEnableDisable();
            RefreshDataGrid();
        ...
        private void cmdSAVE_Click(object sender, EventArgs e)
        {
            ...
            using (Database db = new Database(GlobalVar.DBName))
            {
                db.Commands.Add(db.CreateCommand("usp_CF_RencanaSetoran_UPDATE"));
