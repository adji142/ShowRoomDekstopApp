...
namespace ISA.DAL
{
    public class Database:IDisposable 
    {
        ...
        public Database()
        {
            ...
            string connStr = string.Format(connStrTemplate, host, database, user, password);

           

            //connStr = "Data Source=skyline\\sqlexpress; Initial Catalog=ISAdb;Min Pool Size=5;Max Pool Size=60;user id=sa;password=passwordsql;Connect Timeout=300";
        ...
        public Database(string id)
        {
            ...
            //if (ISA.DAL.DAL.Properties.Settings.Default.ISAWeb != "")
            //    connStr = ISA.DAL.DAL.Properties.Settings.Default.ISAWeb.ToString();
            //else
            //    connStr = string.Format(connStrTemplate, host, database, user, password);            //System.Windows.Forms.MessageBox.Show(connStr);
            ////connStr = "Data Source=skyline\\sqlexpress; Initial Catalog=ISAdb;Min Pool Size=5;Max Pool Size=60;user id=sa;password=passwordsql;Connect Timeout=300";
            //_connection = new SqlConnection(connStr);
            //_command = new List<Command>();
            //_connection.Open();
