...
INSERT INTO ISAPalurTradingDb02.dbo.RBDetail
(
	RowID, 
	RBHeaderRowID, 
	NotaBeliRowID, 
...
SELECT		
	...
	(SELECT TOP 1 RowID FROM ISAPalurTradingDb02.dbo.PLDetail pld WHERE pld.RecordID = d.iddtr ) AS NotaBeliRowID,	
	...
	'' AS Alasan,
	@idr AS MataUangOriRowID ,
	0 AS HrgReturBeliOri,
	0 AS HrgReturBeliUSD,
	h_beli AS HrgReturBeliIDR,
	'IMPORT',
	GETDATE(), 
	'IMPORT',
	GETDATE()
