namespace ISA.Showroom.Finance.Keuangan
{
    partial class dlgHitungKurs
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "dlgHitungKurs";
            this.Text = "Hitung Nilai Uang berdasar Kurs";
            this.Title = "Hitung Nilai Uang berdasar Kurs";
