...
namespace ISA.Common
{
    public class Messages
    {
        public struct Error
        {
            ...
            public const string PenjualanStillProblem = "Data Penjualan masih bermasalah";
        }
        ...
        {
            public const string LoginFailed = "Login gagal, salah nama user atau password";
            ...
            public const string UploadFailed = "Proses Upload gagal, silakan coba lagi";
