...
namespace ISA.Showroom.Controls
{
    public partial class frmLookUpVendor : ISA.Controls.BaseForm
    {
        ...
        public Class.clsVendor Vendor { get; set; }
        bool pusat = false;
        ...
        public frmLookUpVendor(DataTable dt)
        {
        ...
        void DBGetList()
        {
            try
            {
                _dtCari = Class.clsVendor.DBSearch(txtSearch.Text.Trim(), cboFilterNameInitial.Text);
                RefreshGrid();
            }
            catch (Exception ex)
            {
