...
{
    public partial class frmPenjualanBrowseADS : ISA.Controls.BaseForm
    {
        ...
        public void RefreshData()
        {
            try
            {
                ...
                Database db2 = new Database();
                {
                    ...
                    db1.Commands[0].Parameters.Add(new Parameter("@FlagSource", SqlDbType.VarChar, "ORI"));
                    ...
                    db2.Commands[0].Parameters.Add(new Parameter("@FlagSource", SqlDbType.VarChar, "ORI"));
        ...
        private void frmPenjualanBrowseADS_Load(object sender, EventArgs e)
        {
        ...
        {
            Penjualan.frmPenjualanUpdateADS ifrmChild = new Penjualan.frmPenjualanUpdateADS(this);
        ...
        private void cmdEDIT_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedCells.Count > 0)
            {
                ...
                */
                ...
                if (isOk == true)
                {
                    Penjualan.frmPenjualanUpdateADS ifrmChild = new Penjualan.frmPenjualanUpdateADS(this, rowID);
                    Program.MainForm.CheckMdiChildren(ifrmChild);
                    RefreshData();
                }
                else
        ...
        private void cmdViewDetail_Click(object sender, EventArgs e)
        {
            ...
            {
                Guid rowID = (Guid)dataGridView1.SelectedCells[0].OwningRow.Cells["RowID"].Value;
                Penjualan.frmPenjualanUpdateADS ifrmChild = new Penjualan.frmPenjualanUpdateADS(this, rowID, "PEEK");
                Program.MainForm.CheckMdiChildren(ifrmChild);
            }
            else
            {
            ...
            try
            {
                ...
                */
                ...
                using (Database db = new Database())
                {
                    ...
                    db.Commands[0].Parameters.Add(new Parameter("@CabangID", SqlDbType.VarChar, GlobalVar.CabangID));
                    db.Commands[0].Parameters.Add(new Parameter("@FlagSource", SqlDbType.VarChar, "ORI")); // yg baru tapi yg bekas...
