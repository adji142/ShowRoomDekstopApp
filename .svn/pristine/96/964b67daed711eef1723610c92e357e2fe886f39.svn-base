...
{
    public partial class frmCF_RencanaSetoran_koreksi : ISA.Controls.BaseForm
    {
        List<TextBox> _lTxtJumlah = new List<TextBox>();
        Guid _RowID;

        public frmCF_RencanaSetoran_koreksi()
        {
            InitializeComponent();
        ...
        private void RefreshData()
        {
            ...
            {
                db.Commands.Add(db.CreateCommand("usp_CF_KoreksiRencanaSetoran_LIST"));
        ...
        private void frmCF_RencanaSetoran_koreksi_Load(object sender, EventArgs e)
        {
            InitControl();
            SetEnableDisable();
            RefreshData();
        ...
        private void cmdSAVE_Click(object sender, EventArgs e)
        {
            ...
            using (Database db = new Database(GlobalVar.DBName))
            {
                db.Commands.Add(db.CreateCommand("usp_CF_KoreksiRencanaSetoran_UPDATE"));
