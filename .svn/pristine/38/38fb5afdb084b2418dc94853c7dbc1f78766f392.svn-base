...
{
    public partial class frmLookUpCustomer : ISA.Controls.BaseForm
    {
        ...
        public frmLookUpCustomer(DataTable dt)
        {
        ...
        void DBGetList()
        {
            try
            {
                _dtCari = Class.clsCostumer.DBSearch(txtSearch.Text.Trim(), cboFilterNameInitial.Text);
                RefreshGrid();
            }
            catch (Exception ex)
            {
