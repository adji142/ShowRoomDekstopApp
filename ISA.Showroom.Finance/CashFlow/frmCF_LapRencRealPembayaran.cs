...
{
    public partial class frmCF_LapRencRealPembayaran : ISA.Controls.BaseForm
    {
        public frmCF_LapRencRealPembayaran()
        {
            InitializeComponent();
        ...
        private void cmdPRINT_Click(object sender, EventArgs e)
        {
            ...
            {
                db.Commands.Add(db.CreateCommand("rsp_CF_RencRealPembayaran"));
            ...
            frmReportViewer ifrmReport = new frmReportViewer("CashFlow.rptCF_RencRealPembayaran.rdlc", Params, dt, "dsCashFlow_LapPembayaran");
            ifrmReport.Show();
        }
    }
}
